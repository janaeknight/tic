...
function tact2() {
    var tic = document.getElementById("t2");
        if (tic.innerText.length<1) {
            tic.innerHTML = "X";
            turns += 1;
            userTurns += 1;
...
function tact3() {
    var tic = document.getElementById("t3");
        if (tic.innerText.length<1) {
            tic.innerHTML = "X";
            turns += 1;
            userTurns += 1;
...
function tacm1() {
    var tic = document.getElementById("m1");
        if (tic.innerText.length<1) {
            tic.innerHTML = "X";
            turns += 1;
            userTurns += 1;
...
function tacm2() {
    var tic = document.getElementById("m2");
        if (tic.innerText.length<1) {
            tic.innerHTML = "X";
            turns += 1;
            userTurns += 1;
...
function tacm3() {
    var tic = document.getElementById("m3");
        if (tic.innerText.length<1) {
            tic.innerHTML = "X";
            turns += 1;
            userTurns += 1;
...
function tacb1() {
    var tic = document.getElementById("b1");
        if (tic.innerText.length<1) {
            tic.innerHTML = "X";
            turns += 1;
            userTurns += 1;
...
function tacb2() {
    var tic = document.getElementById("b2");
        if (tic.innerText.length<1) {
            tic.innerHTML = "X";
            turns += 1;
            userTurns += 1;
...
function tacb3() {
    var tic = document.getElementById("b3");
        if (tic.innerText.length<1) {
            tic.innerHTML = "X";
            turns += 1;
            userTurns += 1;
